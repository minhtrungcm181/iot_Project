...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"minhtrung181/feeds/nhietdo", "minhtrung181/feeds/button", "minhtrung181/feeds/ping", "minhtrung181/feeds/period", "minhtrung181/feeds/humidity"};
    final String clientId = "minhtrung181";
    final String username = "minhtrung181";
    final String password = "aio_GiYj94zWclHiGM0iSawETZi9rPGx";
